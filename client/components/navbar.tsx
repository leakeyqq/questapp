            ...
            {isAuthenticated && user ? (
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="ghost"
                    className="flex items-center space-x-2 px-3 py-2 rounded-lg hover:bg-brand-light"
                  >
                    <div className="h-8 w-8 bg-brand-purple rounded-full flex items-center justify-center overflow-hidden">
                      {user.profileImage ? (
                        <img src={user.profileImage} alt={user.name || 'User'} className="h-8 w-8 object-cover rounded-full" />
                      ) : (
                        <span className="text-sm font-medium text-white">
                          {user.name ? user.name.charAt(0).toUpperCase() : address?.slice(2, 4).toUpperCase()}
                        </span>
                      )}
                    </div>
                ...
                <div className="flex items-center px-3">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="text-sm font-medium text-gray-500 font-mono">
                      {user.name || `${address?.slice(0, 8)}...${address?.slice(-6)}`}
                    </div>
                  </div>
                </div>
