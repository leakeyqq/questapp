        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <a
              ...
              className="group relative inline-flex items-center justify-center px-6 py-3.5 mb-6 overflow-hidden rounded-full bg-gradient-to-r from-brand-purple to-[#00aced] text-white font-medium shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-white/20"
            >
              <span className="absolute inset-0 bg-gradient-to-r from-brand-purple via-[#00aced] to-[#2aabee] opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-lg"></span>
              <span className="absolute -inset-1 rounded-full bg-gradient-to-r from-brand-purple via-[#00aced] to-[#2aabee] opacity-30 group-hover:opacity-50 animate-pulse transition-opacity duration-500 blur-sm"></span>
            ...
            <a
              href="https://chat.whatsapp.com/Leshteh6aV1Bku8S0Uvm7d"
              target="_blank"
              rel="noopener noreferrer"
              className="group relative inline-flex items-center justify-center px-6 py-3.5 mb-6 overflow-hidden rounded-full bg-gradient-to-r from-brand-purple to-[#128C7E] text-white font-medium shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-white/20"
            >
              <span className="absolute inset-0 bg-gradient-to-r from-brand-purple via-[#1DA851] to-[#128C7E] opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-lg"></span>
              <span className="absolute -inset-1 rounded-full bg-gradient-to-r from-brand-purple via-[#1DA851] to-[#128C7E] opacity-30 group-hover:opacity-50 animate-pulse transition-opacity duration-500 blur-sm"></span>
              <span className="relative flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="22"
            ...
            <div className="flex space-x-4">
              <a
                href="https://x.com/questpanda_xyz"
              ...
              <a
                href="https://www.linkedin.com/company/questpanda"
                className="text-brand-purple hover:text-brand-pink transition-colors"
              >
              ...
              <a
                href="https://www.instagram.com/questpanda_xyz/"
                className="text-brand-purple hover:text-brand-pink transition-colors"
              >
